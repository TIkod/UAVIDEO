...
const Random = () => {
    ...
    useEffect(() => {
        axios.get(`${process.env.NEXT_PUBLIC_URL_BACK}/videos/random`)
        ...
        <MainLayout>
            <PrivateRoute>
                <div className="container mx-auto py-8">
                    <h1 className="text-4xl font-bold mb-4">Рандомні відео</h1>
                    <p className="text-lg mb-4">Різні відео різних галузей та типів. Можливо щось вам сподобається?</p>
